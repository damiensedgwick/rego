module github.com/damiensedgwick/rego

go 1.23.0

require (
	github.com/bluesky-social/indigo v0.0.0-20240906224005-0de3e30fd572
	github.com/cockroachdb/pebble v1.1.2
	github.com/ericvolp12/jetstream v0.0.0-20240907180253-0a7188a8d40d
